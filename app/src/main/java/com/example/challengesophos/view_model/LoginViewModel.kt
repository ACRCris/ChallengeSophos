...
class LoginViewModel : ViewModel() {
    ...
    fun doLogin(navigationController: NavHostController, loginViewModel: LoginViewModel, context: Context) {
            ...
            if (response.isSuccessful) {
                ...
                if (loginResponse != null) {
                    if(loginResponse.acceso){
                        ...
                        Log.d("Response", "" + loginViewModel.email.value.toString() + " " + loginViewModel.password.value.toString())
                        mToast(context)
                    }
                } else {
                    Log.d("Response", "null")
